...
assignNodePositions(obj);
console.log('Object age after function: ' + obj.age);
...
// modify an arbitrary object in another file and print to see if it works
// isolate it to this file
// I know imports work but not variable changes to objects
